				...
				<div class="agile-row">					
					...
					<div class="login-agileits-top">
						<form action="/search" method="get">
							{{ csrf_field() }}
							<input type="text" class="Title"  id="title" placeholder="Title" name="title">
							<input type="text" class="Author" id="author" placeholder="Author" name="author">							
							<input type="text" class="Publisher" id="publisher" placeholder="Publisher" name="publisher">
							<input type="text" class="Language" id="language"  Placeholder="Language" name="Language">
							<input type="text" class="Translation Title" id="translation"  Placeholder="Translation Title" name="Translation" >							
							<input type="text" class="genre" id="genre" Placeholder="Genre"  name="genre">
