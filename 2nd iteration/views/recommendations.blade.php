...
<div class="col-container">
  ...
  <div>
      <form>
        ...
        <br />
        <center><button class="button button1" ><a href='http://127.0.0.1:8000/addrecord' >Add Record </a></button></center>
      </form>
  </div>
  <div class="clear"></div>
...
<section class='post-item'>
        ...
        <header >
          <a href='http://127.0.0.1:8000/search2/$results->id/$user_id' >  <h1 style='color:#FF3383' class='post-item-title'>$a1</h1></a>
        </header>
