...
<?php		
	...
	if (empty($user_id))
		$user_id=0;
      if(!empty($results)){
        // echo "<a href='http://127.0.0.1:8000/search1/$send' > order according to number of popularity </a>";
      }
$search=$send;
    //echo "$send";
      if(!empty($results)){
...
<section class='post-item'>
        ...
        <header >
          <a href='http://127.0.0.1:8000/search2/$id/$user_id' >  <h1 style='color:#FF3383;' class='post-item-title'>  $a1</h1></a>
        </header>
